...
class Test::Unit::TestCase
  ...
  def set_podio_client
    Podio.client = Podio::Client.new(
      :api_url      => 'http://api-sandbox.podio.dev', # 'http://127.0.0.1:8080',
      :api_key      => 'sandbox@podio.com', #' dev@hoisthq.com',
      :api_secret   => 'sandbox_secret', # 'CmACRWF1WBOTDfOa20A',
  ...
  def login_as(user_identifier)
    ...
    Podio.client.reset
    # set_podio_client(USED_TOKENS[user[:mail]])
  end
