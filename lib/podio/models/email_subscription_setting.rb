...
class Podio::EmailSubscriptionSetting < ActivePodio::Base
  ...
  class << self
    # https://developers.podio.com/doc/email/get-groups-333977
    def get_groups()
    ...
    # https://developers.podio.com/doc/email/update-groups-333981
    ...
    # https://developers.podio.com/doc/email/unsubscribe-from-all-304917
    def unsubscribe(username)
      Podio.connection.post("/email/unsubscribe/#{username}").status
    end

    # https://developers.podio.com/doc/email/get-global-email-contact-as-vcard-13624848
    def get_global_email_as_vcard(name)
      Podio.connection.get("/email/contact/#{name}/vcard").body
    end

    # https://developers.podio.com/doc/email/get-email-contact-for-reference-as-vcard-13628255
    def get_ref_email_as_vcard(name, ref_type, ref_id)
      Podio.connection.get("/email/contact/#{name}/#{ref_type}/#{ref_id}/vcard").body
    end

    # https://developers.podio.com/doc/email/export-global-email-contact-to-linked-account-13629508
    ...
    # https://developers.podio.com/doc/email/export-email-contact-for-reference-to-linked-account-13628926
