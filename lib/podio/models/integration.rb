# https://developers.podio.com/doc/integrations
class Podio::Integration < ActivePodio::Base
  ...
  # https://developers.podio.com/doc/integrations/create-integration-86839
  def create
    self.integration_id = Integration.create(self.app_id, attributes)
  end

  # https://developers.podio.com/doc/integrations/update-integration-86843
  def update
    Integration.update(self.app_id, attributes)
  end

  # https://developers.podio.com/doc/integrations/update-integration-mapping-86865
  def update_mapping
    Integration.update_mapping(self.app_id, attributes)
  end

  # https://developers.podio.com/doc/integrations/delete-integration-86876
  def destroy
    Integration.delete(self.app_id)
  end

  # https://developers.podio.com/doc/integrations/refresh-integration-86987
  def refresh
  ...
  class << self
    ...
    # https://developers.podio.com/doc/integrations/get-integration-86821
    def find(app_id)
      member Podio.connection.get("/integration/#{app_id}").body
    end

    # https://developers.podio.com/doc/integrations/get-available-fields-86890
